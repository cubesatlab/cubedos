...
static char test_table[65539];
static char Two[10] = {
    0x11, 0x15, 0xC3, 0xF0, 0x00, 0x05, 0x20, 0xDC, 0x55, 0xF5};
static char test[15] = {
...
static U16 crc_table[256] = {
    ...
    0x1231, 0x0120, 0x3273, 0x2252, 0x52b5, 0x4294, 0x72f7, 0x62d6,
...
tc_fec_sdlc_s(U16 seed, unsigned char *buf, int len)
{
    U16 crc, t;
    unsigned char *p;
    crc = seed;
...
int main (int argc, char**argv)
{
    ...
    U16 output2 = tc_fec_sdlc_s(temp, Two, 10);
    printf("%x \n \n", output2);
}
