...
class SpecificationGenerator(
  ...
  def processTemplate(): List[String] = {
    val source = scala.io.Source.fromFile("/home/CubeSat/Projects/CubeSat/trunk/CubedOS/XDR2OS3/mxdrTests/template.ads")
  ...
  override def visitEnum_body(ctx: XDRParser.Enum_bodyContext): Void = {
  ...
  //Decode.
  def doDecode(ctx: XDRParser.Struct_bodyContext, id: String, m_i: List[String], arrowFlag: Int): Void = {
  ...
  //Encode sending.
  def doEncode(ctx: XDRParser.Struct_bodyContext, id: String, m_i: List[String], arrowFlag: Int): Void = {
  ...
  def visitRange_constraint(ctx: XDRParser.Range_constraintContext, floatFlag: Int): Void
