...
\label{sec:development-requirements}

In this section we detail the requirements of the various CubedOS core modules. These
...
\label{sec:requirements-core-requirements}
...
\label{sec:requirements-runtime-library}
...
\label{sec:requirements-core-modules}
...
\label{sec:requirements-message-manager}
...
\subsubsection{Time Server}
\label{sec:requirements-time-server}
...
\label{sec:requirements-file-server}
...
\label{sec:requirements-interpreter}
...
\label{sec:requirements-log-server}
...
\pet{Need to talk about the modules that interface to standard busses and other low level
  ...
  only rewriting the HAL modules.}
