...
\pet{Provide citation} However, the intent is for CubedOS to be general enough and modular
...
\newterm{modules} can be plugged to implement whatever mission functionality is required.
