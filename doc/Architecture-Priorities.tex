...
priority remains unchanged at its base priority. \pet{Is this the right semantic? Or should the
  priority always match that of the message?} Thus a high priority module services low priority
messages at its usual (high) priority. In contrast a low priority module services high priority
messages at a temporarily elevated priority. This \newterm{priority inheritance} is needed so a
