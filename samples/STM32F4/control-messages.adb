...
package body Control.Messages is
   ...
   procedure Handle_Subscribe_Result(Message : in Message_Record)
     with Pre => Publish_Subscribe.API.Is_Publish_Result(Message)
   is
   ...
   begin
      ...
      elsif Publish_Subscribe.API.Is_Publish_Result(Message) then
         Handle_Subscribe_Result(Message);

      elsif Publish_Subscribe.API.Is_Subscribe_Reply(Message) then
